...
imkreg01 <- function(y,exvar.beta=NA,exvar.nu=NA,exvar.rho=NA,tau=0.5,graph=T,print=T,check=F,link="logit")
{
  n <- length(y) 
  ...
  ajuste = lm.fit(as.matrix(X[y!=0 & y!=1,]), Ynew)
  ...
  #null hypothesis: non autocorrelated
